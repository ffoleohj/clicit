        ...
        <div class="ps-checkout">
            <div class="container">
                <ul class="ps-breadcrumb">
                    <li class="ps-breadcrumb__item"><a href="index.html">Inicio</a></li>
                    <li class="ps-breadcrumb__item active" aria-current="page"> Verificación de la compra</li>
                </ul>
                <h3 class="ps-checkout__title"> Verificación de la compra</h3>
                <div class="ps-checkout__content">
                    <div class="ps-checkout__wapper">
                        <p class="ps-checkout__text">¿Ya tienes una cuenta registrada?<a href="login.php"> Iniciar Sesión</a></p>
                    </div>
                    <form action="" method="post">
                        <div class="row">
                            <div class="col-12 col-lg-8">
                                <div class="ps-checkout__form">
                                    <h3 class="ps-checkout__heading">Datos del comprado</h3>
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="ps-checkout__group">
                                                <label class="ps-checkout__label">Correo Electronico: </label>
                                        ...
                                        <div class="col-12">
                                            <div class="ps-checkout__group">
                                                <label class="ps-checkout__label">Nombre de la empresa (Opcional)</label>
                                                <input class="ps-input" type="text">
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="ps-checkout__group">
                                                <label class="ps-checkout__label">Provincia</label>
                                                <input class="ps-input" type="text">
                                            </div>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="col-12 col-md-6">
                                            <div class="ps-checkout__group">
                                                <label class="ps-checkout__label">Referencia 1:</label>
                                                <input class="ps-input" type="text">
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            <div class="ps-checkout__group">
                                                <label class="ps-checkout__label">Referencia 2:</label>
                                                <input class="ps-input" type="text">
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="ps-checkout__group">
                                                <label class="ps-checkout__label">Teléfono / Celular: </label>
                                                <input class="ps-input" type="text">
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="ps-checkout__group">
                                                <label class="ps-checkout__label">Mensaje: </label>
                                                <textarea class="ps-textarea" rows="7" placeholder="Escribenos un mensaje"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-12 col-lg-4">
                                <div class="ps-checkout__order">
                                    <h3 class="ps-checkout__heading">Tu compra</h3>
                                    <div class="ps-checkout__row">
                                        <div class="ps-title">Producto(s)</div>
                                        <div class="ps-title">Subtotal</div>
                                    </div>
                                    <div class="ps-checkout__row ps-product">
                                        <div class="ps-product__name">Nombre del producto x <span>1</span></div>
                                        <div class="ps-product__price">S/ 00.00</div>
                                    </div>
                                    <div class="ps-checkout__row">
                                        <div class="ps-title">Subtotal</div>
                                        <div class="ps-product__price">S/ 00.00</div>
                                    ...
                                    <div class="ps-checkout__row">
                                        <div class="ps-title">Compra</div>
                                        <div class="ps-checkout__checkbox">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" id="price-ship1">
                                                <label class="form-check-label" for="price-ship1">Envío gratis</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" id="price-ship2">
                                                <label class="form-check-label" for="price-ship2">Envío a provincia: <span>S/ 00.00</span></label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="ps-checkout__row">
                                    ...
                                    <div class="ps-checkout__payment">
                                        <div class="check-faq">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="agree-faq"> Para pagar con VISA o MASTERCARD, ingresar a esta opción para concretar la operación, ClicIT le brindará una ZONA SEGURA DE PAGO.</label>
                                            </div>
                                        </div>
                                        <button class="ps-btn ps-btn--warning">Realizar pago</button>
                                    </div>
                                </div>
                            </div>
                        </div>
