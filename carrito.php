        ...
        <div class="ps-shopping">
            <div class="container">
                <ul class="ps-breadcrumb">
                    ...
                    <li class="ps-breadcrumb__item active" aria-current="page">Carrito de Compras</li>
                </ul>
                <h3 class="ps-shopping__title">Carrito de Compras <sup> (1)</sup></h3>
                        ...
                        <div class="col-12 col-md-7 col-lg-9">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="ps-product__thumbnail"><a class="ps-product__image" href="#">
                                                    <figure><img src="img/slider/p5.png" alt></figure>
                                                </a></td>
                                            <td class="ps-product__name"> <a href="#">Nombrel del producto</a></td>
                                            ...
                                            <td class="ps-product__subtotal">S/ 00.00</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            <div class="ps-shopping__footer">
                                <div class="ps-shopping__coupon">
                                    <button class="ps-btn ps-btn--primary" type="button">Seguir comprando</button>
                                </div>
                                <div class="ps-shopping__button">
                                    <button class="ps-btn ps-btn--primary" type="button">Eliminar todo</button>
                                    <button class="ps-btn ps-btn--primary" type="button">Actualizar</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-md-5 col-lg-3">
                            <div class="ps-shopping__label">Total del Carrito</div>
                            <div class="ps-shopping__box">
                                <div class="ps-shopping__row">
                                    <div class="ps-shopping__label">Subtotal</div>
                                    <div class="ps-shopping__price">S/ 00.00</div>
                                </div>
                                <div class="ps-shopping__label">Opciones de Delivery</div>
                                <div class="ps-shopping__checkbox">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" id="cart-ship1">
                                        <label class="form-check-label" for="cart-ship1">Envío gratis</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" id="cart-ship2">
                                        <label class="form-check-label" for="cart-ship2">Envío a Departamento</label>
                                    </div>
                                </div>
                                <a class="ps-shopping__toggle" href="#">Calcular el envío</a>
                                <div class="ps-shopping__form">
                                    ...
                                    <div class="ps-shopping__group">
                                        <input class="form-control ps-input" type="text" placeholder="Dirección">
                                    </div>
                                    <div class="ps-shopping__group">
                                        <input class="form-control ps-input" type="text" placeholder="Referencia">
                                    </div>
                                    <div class="ps-shopping__group">
                                        <input class="form-control ps-input" type="text" placeholder="Número de Contacto">
                                    </div>
                                </div>
                                <div class="ps-shopping__row">
                                ...
                                <div class="ps-shopping__checkout"><a class="ps-btn ps-btn--warning" href="verificacion.php">Proceder con la compra</a><a class="ps-shopping__link" href="productos.php">Seguir comprando</a></div>
                            </div>
                        </div>
                    </div>
